<!-- TEST 03/10/2016 -->
<div class="chat" id="liveagent_button_online_573L00000004CTm">
  <div>Welcome to Live FT Chat</div>
  <a href="javascript:liveagent.startChat('573L00000004CTm');void(0);" role="button" class="cta chat-online o-buttons o-buttons--b2c">Start Chat</a>
</div>

<div class="chat" id="liveagent_button_offline_573L00000004CTm">
  <div>Welcome to Live FT Chat</div>
